...
// jsonObj is a JSON object representation.
type jsonObj map[string]interface{}

func (c *converter) getHclJSON(bytes []byte, filename string) (interface{}, error) {
...
func (c *converter) ToJSON() ([]byte, error) {
	content, err := c.getHclJSON(c.bytes, "")
	if err != nil {
